...
function addProduct() {
  ...
  // Check if the total expenses exceed the total budget
  const totalBudget = parseFloat(totalMoneyInput.value);
  if (total > totalBudget) {
    alert('You are spending more than your total budget limit!');
  }
